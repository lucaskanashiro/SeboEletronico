...
class UsuarioDao {
    ...
    public function alteraUsuario($nome, $email, $telefone, $senha, $idDoUsuario){
        ...
        $resultado = $id_senha = pg_query($sql2);
        $id_senha = mysql_fetch_array($resultado);
...
//        mysql_query(conectaBanco(), $sql3);
    ...
    public static function checaCadastro($email, $senha){
        ...
        $resultado = mysql_fetch_array($emailBuscado);
        var_dump($resultado);
        exit;
        
        $sql2="SELECT * FROM senha WHERE codigo_senha = '".$senha."'";
        $codigoDaSenhaBuscado = mysql_query($sql2);
        $resultado1 = mysql_fetch_array($codigoDaSenhaBuscado);
    ...
    public static function getCadastradosPorId($idPessoa){
        ...
        $resultado = $id_senha = mysql_query($sql);
